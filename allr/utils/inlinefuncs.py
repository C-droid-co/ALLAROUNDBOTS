...
from allr.core.keyboard import ikb
from allr.core.tasks import _get_tasks_text, all_tasks, rm_task
from allr.core.types import InlineQueryResultCachedDocument
from allr.modules.info import get_chat_info, get_user_info
from allr.modules.music import download_youtube_audio
from allr.utils.functions import test_speedtest
from allr.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            title="Channel link",
            description="Get Channel Link of Bot.",
            input_message_content=InputTextMessageContent(
                "https://https://t.me/cleaneroobot"
            ),
...
async def alive_function(answers):
    ...
    msg = f"""
**[Cleaner Robot](https://https://t.me/cleaneroobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
